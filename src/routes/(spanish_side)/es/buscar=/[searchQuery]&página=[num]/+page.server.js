...
export async function load({ params, fetch }) {
    ...
    const searchFetch = await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${TMDB_API_KEY}&language=es-MX&query=${userSearchQuery}&page=${userPageQuery}&include_adult=false&region=US`);
